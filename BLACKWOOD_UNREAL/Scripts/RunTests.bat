@echo off
setlocal
rem TESTE : tests automatisés « Blackwood.* » (comparaison avec la version Godot), sans fenêtre.
rem Résultats : Saved\Automation\index.json et le journal Saved\Logs\Blackwood.log
