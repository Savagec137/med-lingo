/**
 * L'ancien Mode Intervention, conservé hors circuit.
 *
 * Ce n'était pas une simulation : les quinze missions y étaient jouées comme un
 * enchaînement de questions à choix, construites par `intervention-scenario-builder`
 * depuis une banque de contenu. Et il affichait gratuitement ce que le mode V3
 * fait gagner — le pouls et l'état du patient sont déclarés dans le JSON de
 * mission et rendus sans qu'aucune action ne les mérite.
 *
 * La route `/intervention` mène désormais au simulateur. Ce fichier n'est plus
 * monté nulle part ; il est gardé parce qu'il porte encore quinze missions de
 * contenu rédigé, et que les supprimer serait une décision à prendre à part.
 */
...
export function InterventionLegacyScreen() {
