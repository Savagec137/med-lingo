...
import { Box, Coins, Gem, Sparkles, WalletCards, Zap } from "lucide-react";
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {collection.map((item) => (
                    <InventoryItemCard
                      ...
                      equipped={
                        (item.itemType === "avatar" &&
                          profileCosmetics.avatarCode === item.itemCode) ||
                        (item.itemType === "badge" &&
                          profileCosmetics.badgeCode === item.itemCode) ||
