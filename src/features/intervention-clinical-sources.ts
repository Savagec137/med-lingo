...
export const INTERVENTION_CLINICAL_REFERENCES: readonly ClinicalKnowledgeReference[] = [
  {
    ...
    sourcePages: "10",
    repositoryPath: "docs/official_sources/Code_Santé_Publique/joe_20220417_0091_0039.pdf",
  ...
  },
  {
    ...
    sourcePages: "14",
    repositoryPath:
      "docs/official_sources/Transport_Sanitaire/VFF_Referentiel_formation_securite_routiere_et_conduite_en_intervention_urgence_ambulanciers_SMUR_SFMU_AFASH_ANCESU_2026.pdf",
    reviewStatus: "source_verified",
  ...
  },
  {
    ...
    sourcePages: "66,67",
    repositoryPath: "docs/internal_sources/Cours_DEA/B2.M4 - Support Etudiant.pdf",
    reviewStatus: "source_verified",
