...
import { Brain, Cross, Dna, HeartPulse, ShieldPlus, Sparkles, Stethoscope, UserRound } from "lucide-react";
...
export type ProfileCardDefinition = {
  ...
  name: string;
  /** Ligne d'ambiance affichée sur la carte */
  tagline: string;
  ...
  background: string;
  accent: string;
  /** Couleur secondaire utilisée par le décor animé */
  accentAlt: string;
  foreground: string;
  muted: string;
};
