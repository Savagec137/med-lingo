    ...
    lessons: [
      {
        ...
        questions: [
          q(
            "os-1-1",
            "Comment s'appelle l'os du front ?",
            ["Frontal", "Pariétal", "Occipital", "Temporal"],
            0,
          ),
          q(
            "os-1-2",
            "Quel os forme la mâchoire inférieure ?",
            ["Maxillaire", "Mandibule", "Zygomatique", "Vomer"],
            1,
          ),
          q(
            "os-1-3",
            "Où se trouve l'os occipital ?",
            ["Devant le crâne", "Sur les côtés", "À l'arrière du crâne", "Sous la mâchoire"],
            2,
          ),
          q("os-1-4", "Combien y a-t-il d'os pariétaux ?", ["1", "2", "3", "4"], 1),
          q(
            "os-1-5",
            "Les os zygomatiques forment les :",
            ["Tempes", "Pommettes", "Sourcils", "Oreilles"],
            1,
          ),
        ],
      },
      {
        ...
        questions: [
          ...
          q(
            "os-2-4",
            "L'atlas est :",
            ["La 1ère cervicale", "La 1ère lombaire", "Le sacrum", "Le coccyx"],
            0,
          ),
          q(
            "os-2-5",
            "Le sacrum est composé de vertèbres :",
            ["Mobiles", "Soudées", "Cartilagineuses", "Absentes"],
            1,
          ),
        ],
      },
      {
        ...
        questions: [
          ...
          q(
            "os-3-2",
            "Os de l'avant-bras (côté pouce) ?",
            ["Cubitus", "Ulna", "Radius", "Carpe"],
            2,
          ),
          ...
          q(
            "os-3-4",
            "Le carpe se trouve :",
            ["Au poignet", "Au coude", "À l'épaule", "Au doigt"],
            0,
          ),
      ...
      },
      {
        ...
        questions: [
          ...
          q(
            "os-4-2",
            "La rotule protège :",
            ["La hanche", "Le genou", "La cheville", "Le coude"],
            1,
          ),
          ...
          q(
            "os-4-5",
            "Tarse, métatarse, phalanges sont les os :",
            ["De la main", "Du pied", "Du bassin", "Du crâne"],
            1,
          ),
        ],
      },
    ...
    lessons: [
      {
        ...
        questions: [
          ...
          q(
            "org-1-2",
            "Les ventricules éjectent le sang vers :",
            ["Les oreillettes", "Les artères", "Les veines caves", "Les capillaires"],
            1,
          ),
          q(
            "org-1-3",
            "Le sang oxygéné arrive au cœur par :",
            ["Veines caves", "Veines pulmonaires", "Artère aorte", "Artères pulmonaires"],
            1,
          ),
          q(
            "org-1-4",
            "La plus grosse artère du corps ?",
            ["Fémorale", "Carotide", "Aorte", "Pulmonaire"],
            2,
          ),
          q(
            "org-1-5",
            "Les valvules empêchent :",
            ["La coagulation", "Le reflux du sang", "L'oxygénation", "La contraction"],
            1,
          ),
        ],
      },
      {
        ...
        questions: [
          q(
            "org-2-1",
            "L'air passe des bronches aux :",
            ["Alvéoles", "Ventricules", "Néphrons", "Villosités"],
            0,
          ),
          q(
            "org-2-2",
            "Le muscle principal de la respiration ?",
            ["Diaphragme", "Trapèze", "Cœur", "Larynx"],
            0,
          ),
          q(
            "org-2-3",
            "La trachée se divise en :",
            ["Bronchioles", "Bronches", "Alvéoles", "Poumons"],
            1,
          ),
          q("org-2-4", "Le poumon droit a combien de lobes ?", ["1", "2", "3", "4"], 2),
          q(
            "org-2-5",
            "Les échanges gazeux se font dans :",
            ["La trachée", "Le larynx", "Les alvéoles", "Les bronches"],
            2,
          ),
        ],
      },
      {
        ...
        questions: [
          q(
            ...
            "Ordre correct :",
            [
              "Bouche → estomac → œsophage",
              "Bouche → œsophage → estomac",
              "Estomac → bouche → intestin",
              "Œsophage → bouche → estomac",
            ],
            1,
          ),
          ...
          q(
            "org-3-3",
            "L'absorption des nutriments se fait principalement dans :",
            ["L'estomac", "Le côlon", "L'intestin grêle", "L'œsophage"],
            2,
          ),
          q(
            "org-3-4",
            "Le pancréas sécrète :",
            ["Bile uniquement", "Insuline et enzymes", "Urée", "Salive"],
            1,
          ),
          q(
            "org-3-5",
            "Le côlon fait partie de :",
            ["L'intestin grêle", "Le gros intestin", "L'estomac", "Le foie"],
            1,
          ),
        ],
      },
      {
        ...
        questions: [
          q(
            ...
            ["Alvéole", "Néphron", "Neurone", "Villosité"],
            1,
          ),
          q(
            "org-4-2",
            "L'urine passe du rein à la vessie par :",
            ["L'urètre", "L'uretère", "Le canal cholédoque", "Le tube digestif"],
            1,
          ),
          q(
            "org-4-3",
            "La cellule du système nerveux est :",
            ["Neurone", "Néphron", "Myocyte", "Hépatocyte"],
            0,
          ),
          q(
            "org-4-4",
            "Le SNC comprend :",
            ["Cerveau et moelle épinière", "Nerfs uniquement", "Muscles", "Glandes"],
            0,
          ),
          q(
            "org-4-5",
            "Le cervelet contrôle :",
            ["La vision", "L'équilibre et coordination", "La digestion", "La respiration"],
            1,
          ),
        ],
      },
    ...
    lessons: [
      {
        ...
        questions: [
          q(
            "pref-1-1",
            "« Hyper- » signifie :",
            ["En dessous", "Au-dessus / excès", "Autour", "Avant"],
            1,
            "Hypertension = tension trop élevée.",
          ),
          q(
            "pref-1-2",
            "« Hypo- » signifie :",
            ["Excès", "Insuffisance / en dessous", "Autour", "À travers"],
            1,
          ),
          q(
            "pref-1-3",
            "« Péri- » signifie :",
            ["À l'intérieur", "Autour", "Avant", "Sous"],
            1,
            "Péricarde = autour du cœur.",
          ),
          q(
            "pref-1-4",
            "« Endo- » signifie :",
            ["À l'extérieur", "Autour", "À l'intérieur", "Au-dessus"],
            2,
          ),
      ...
      },
      {
        ...
        questions: [
          ...
          q(
            "pref-2-4",
            "« Dys- » signifie :",
            ["Bien", "Difficulté / anomalie", "Excès", "Absence"],
            1,
    ...
    lessons: [
      {
        ...
        questions: [
          q(
            "suf-1-1",
            "« -ite » indique :",
            ["Une ablation", "Une inflammation", "Une tumeur", "Une douleur"],
            1,
            "Ex : appendicite, gastrite.",
          ),
          q(
            "suf-1-2",
            "« -ome » indique souvent :",
            ["Une inflammation", "Une tumeur", "Un rétrécissement", "Un examen"],
            1,
            "Ex : carcinome, lipome.",
          ),
          q(
            "suf-1-3",
            "« -algie » signifie :",
            ["Ablation", "Douleur", "Formation", "Rupture"],
            1,
            "Ex : névralgie, myalgie.",
          ),
          q(
            "suf-1-4",
            "« -ose » indique :",
            ["Inflammation aiguë", "Maladie / état chronique", "Douleur", "Coupure"],
            1,
            "Ex : arthrose, cirrhose.",
          ),
          q(
            "suf-1-5",
            "« -pathie » signifie :",
            ["Guérison", "Maladie", "Réparation", "Analyse"],
            1,
          ),
        ],
      },
      {
        ...
        questions: [
          q(
            "suf-2-1",
            "« -ectomie » signifie :",
            ["Ouverture", "Ablation chirurgicale", "Examen", "Suture"],
            1,
          ...
          q(
            "suf-2-2",
            "« -tomie » signifie :",
            ["Ablation", "Incision / ouverture", "Réparation", "Mesure"],
            1,
          ),
          q(
            "suf-2-3",
            "« -stomie » signifie :",
            ["Ablation", "Création d'un abouchement", "Suture", "Fermeture"],
            1,
            "Colostomie = abouchement du côlon.",
          ),
          q(
            "suf-2-4",
            "« -scopie » signifie :",
            ["Ablation", "Examen visuel avec instrument", "Réparation", "Radiographie"],
            1,
          ),
          q(
            "suf-2-5",
            "« -graphie » désigne :",
            ["Une chirurgie", "Un enregistrement / image", "Une douleur", "Une inflammation"],
            1,
          ),
        ],
      },
    ...
    lessons: [
      {
        ...
        questions: [
          ...
          q(
            "rad-1-4",
            "« Pneumo- » désigne :",
            ["Le rein", "Le poumon", "Le pancréas", "Le colon"],
            1,
          ),
          q(
            "rad-1-5",
            "« Gastro- » désigne :",
            ["L'intestin", "L'estomac", "Le foie", "Le pancréas"],
            1,
          ),
        ],
      },
    ...
    lessons: [
        ...
        questions: [
          q(
            ...
            [
              ...
              "Une nécrose du muscle cardiaque",
              "Un trouble digestif",
          ...
          q(
            "pat-1-2",
            "« Péricardite » signifie :",
            [
              "Ablation du péricarde",
              "Inflammation autour du cœur",
              "Tumeur du cœur",
              "Rythme lent",
            ],
            1,
            "Péri- (autour) + card (cœur) + -ite (inflammation).",
          ),
          q(
            "pat-1-3",
            "Une bronchite est :",
          ...
          q(
            "pat-1-4",
            "La BPCO touche :",
            ["Les reins", "Les poumons", "Le foie", "Le cerveau"],
            1,
          ),
          q(
            "pat-1-5",
      ...
      },
      {
        ...
        questions: [
          q(
            "pat-2-1",
            "« Gastrite » signifie :",
            ["Ablation de l'estomac", "Inflammation de l'estomac", "Tumeur", "Rétrécissement"],
            1,
          ),
          q(
            "pat-2-2",
            "Une cirrhose touche :",
            ["Le rein", "Le foie", "Le pancréas", "L'estomac"],
            1,
          ),
          q(
            "pat-2-3",
            "« Néphrite » signifie :",
            ["Inflammation du rein", "Ablation du rein", "Douleur du rein", "Calcul rénal"],
            0,
          ),
          q(
            "pat-2-4",
        ...
        questions: [
          q(
            ...
            [
              ...
              "Une usure chronique des articulations",
              "Une fracture",
              "Un cancer",
            ],
            1,
          ...
          q(
            "pat-3-2",
            "L'ostéoporose est :",
            ["Une fragilité des os", "Une tumeur osseuse", "Une luxation", "Une infection"],
            0,
          ),
          q(
            "pat-3-3",
            "Une myalgie est :",
            ["Une douleur musculaire", "Une inflammation osseuse", "Une paralysie", "Une fracture"],
            0,
            "Myo- (muscle) + -algie (douleur).",
          ),
          q(
            "pat-3-4",
            "L'AVC est :",
      ...
      },
      {
        ...
        questions: [
          ...
          q(
            "pat-4-3",
            "« Bradycardie » signifie :",
            ["Rythme cardiaque rapide", "Rythme cardiaque lent", "Arrêt cardiaque", "Fibrillation"],
            1,
          ),
          q(
            "pat-4-4",
          ...
          q(
            "pat-4-5",
            "« Néphrectomie » signifie :",
            ["Inflammation du rein", "Examen du rein", "Ablation du rein", "Douleur du rein"],
            2,
          ),
        ],
      },
