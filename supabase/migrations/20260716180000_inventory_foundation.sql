...
-- Cette migration est additive : les tables historiques restent utilisables.
...
-- Le portefeuille historique reste la source des opérations existantes.
-- Ce miroir garantit que les nouvelles vues d'inventaire restent exactes.
...
-- Moteur unique de récompenses. Les clients ne créditent jamais de solde directement.
...
-- Les achats historiques restent synchronisés avec l'inventaire moderne.
